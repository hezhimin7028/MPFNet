...
class P_agf(nn.Module):
    def __init__(self, args):
        super(P_agf, self).__init__()
    ...
    def forward(self, x):
        ...
        return [f_st_g[1],  f_si_g[1], f_ly_g[1] ], predict_abc, tri_feat, fuse_feat[-1], fuse_feat[1]
